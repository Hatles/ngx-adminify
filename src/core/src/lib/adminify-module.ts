...
import {AdminifyRouterModule, provideAsyncRoutesByFactory, provideAsyncRoutesFactory} from '@angular/router/adminify-router-module';
import {AsyncRoutes, AsyncRoutesFactory} from '@angular/router/adminify-router-config';
