...
export function provideAsyncInitializer(): Provider[] {
    return [
        {
            provide: DYNAMIC_MODULE_INITIALIZER,
            useFactory: asyncItemsInitializerFactory,
            deps: [AsyncItemRegistry, [new Optional(), ASYNC_ITEMS]],
            multi: true
        },
    ];
}
...
export function provideItemAsyncInitializer(itemToken: any, token: any = null, multi: boolean = false): Provider[] {
    return [
        {
            provide: DYNAMIC_MODULE_INITIALIZER,
            useFactory: asyncItemsInitializersFactory,
            deps: [AsyncItemRegistry, [new Optional(), ASYNC_ITEMS_PARAMS]],
            multi: true
        },
